...
def build_diamond_trace(tmp_path: Path, *, run_id: str = "diamond_benchmarks_trace_smoke") -> Path:
    trace_root = tmp_path / "traces"
    cfg = yaml.safe_load(Path("configs/diamond_benchmarks_diamond_trace.yaml").read_text())
    cfg["conditions_csv"] = str(Path("cantera_model/benchmarks_diamond/benchmarks/diamond_cvd/conditions.csv").resolve())
